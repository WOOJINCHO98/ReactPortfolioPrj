                ...
                <Row
                    ...
                    <Col md={4} className="project-box">
                        <ProjectsBox
                            ...
                            description="11기 신입 부원들과 함께 사용하기 위해 진행 한 프로젝트입니다. 아직 개발 중에 있으며, 2월 14일 배포를 예정하고 있습니다. 백엔드 3인, 프론트엔드 3인으로 진행하였습니다. 메인 페이지와 지원 페이지 화면 구현을 담당하였습니다. React를 사용하여 개발하였습니다."
                    ...
                    <Col md={4} className="project-box">
                        <ProjectsBox
                            ...
                            description="포트폴리오 웹사이트입니다. 개인적으로 진행한 첫 번째 React 프로젝트입니다."
                    ...
                    <Col md={4} className="project-box">
                        <ProjectsBox
                            ...
                            description="CGV 영화관의 데이터베이스를 구축하고, 관리자와 사용자의 기능을 구현하였습니다. 교내의 데이터베이스 수업에서 진행했던 프로젝트입니다. 세부적인 문서화 작업으로 상당히 오랜 기간이 소요됐던 프로젝트입니다. 팀은 4명으로 이루어져 있었습니다. 프로젝트의 DB 설계 및 기능 구현을 담당하였습니다. Oracle, C#, WinForm 을 사용하여 개발하였습니다. "
                    ...
                    <Col md={4} className="project-box">
                        <ProjectsBox
                            ...
                            header="2013.08.01"
                            title="DicePlugin"
                            description="지금으로부터 10년 전 마인크래프트의 플러그인을 만들었던 경험이 있습니다. 멀티 서버 환경에서 주사위를 던질 수 있는 간단한 플러그인이었습니다."
